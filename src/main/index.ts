...
function createWindow(): void {
  ...
  const mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      sandbox: true, // Permits us to sandbox the renderer process for security
      contextIsolation: true // Makes Javascript run in a separate context from the main process
    }
  })
